...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            "builtins": ['django.templatetags.static'],  # 默认加载静态文件标签
        },
    },
]

WSGI_APPLICATION = 'zaishichang.wsgi.application'
...
#         'PORT': 3306,
#         'USER': 'root',
#         'PASSWORD': 'yuchkkicn',  # PASSWORD这个键必须大写，经测试 django 4.2.3小写的话会报错
#         'NAME': 'qinxuezz'
#     }
# }
...
SIMPLEUI_HOME_ACTION = False  # 是否开启首页 - 最近动作

SIMPLEUI_CONFIG = {
    'system_keep': True,
    'menu_display': ['商品', '用户', '订单', '购物车','可视化'],      # 开启排序和过滤功能, 不填此字段为默认排序和全部显示, 空列表[] 为全部不显示.
